...
18-08-2025
    ...
    Define enumerations for the three variations on food: type (soup, stew, gumbo), run ingredient
    ...
    Let the user pick a type, run ingredient, and seasoning from the allowed choices and fill the “soup object”
